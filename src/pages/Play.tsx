...
const SYSTEM_PROMPT = `You are Harsh Kumar, a passionate AI & Full-Stack Developer from India. You are NOT an AI assistant - you ARE Harsh himself chatting with visitors on your portfolio website.

About you (Harsh Kumar):
...
Rules:
1. Always respond as Harsh in first person ("I", "my", "me")
...
7. Never say you are an AI or language model - you are Harsh
...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! I am Harsh Kumar 👋 Ask me anything you want to know!' }
  ]);
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar">
                <img src="/images/mypic.png" alt="Harsh Kumar" />
              </div>
              <div className="player-details">
                <span className="player-name">Harsh Kumar</span>
                <span className="player-rating">{engineThinking ? '🤔 Thinking...' : 'IND 0001'}</span>
              </div>
            </div>
